  ...
  if ($user) {
    if ($ordine) {
      ...
      if ($orderList->ok()) {
        ...
        $delivery = isset($orderList->get_result()[0]["data_consegna"]) ? $orderList->get_result()[0]["data_consegna"] : "Non ancora inviato";
        $info .= "<div class='carrelloStatus'><p>" . "Data di consegna: " . $delivery . "</p>" . $purchase . "</div>";
